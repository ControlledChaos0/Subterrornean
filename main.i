...
# 1 "background.h" 1
# 20 "background.h"
extern const unsigned short backgroundBitmap[24336];
# 16 "main.c" 2
...
void goToStart() {
    fillScreen(((10) | (0)<<5 | (0)<<10));
    drawString((240 / 2) - 39 , (160 / 2) - 4, "SUB", ((31) | (31)<<5 | (31)<<10));
    drawString((240 / 2) - 21, (160 / 2) - 4, "TERROR", ((31) | (0)<<5 | (0)<<10));
    drawString((240 / 2) + 15 , (160 / 2) - 4, "NEAN", ((31) | (31)<<5 | (31)<<10));
    state = START;
}
...
void goToGame() {
    ...
    drawString(2, (160 / 2 - 10), "Score:", ((31) | (31)<<5 | (31)<<10));
    drawString(16, (160 / 2), "0", ((31) | (31)<<5 | (31)<<10));
    drawGame();
    state = GAME;
}
...
void goToPause() {
    state = PAUSE;
    drawBorderedRect((240 / 2) - 9, (160 / 2) - 13, 7, 25, ((31) | (31)<<5 | (31)<<10), ((0) | (0)<<5 | (0)<<10));
    drawBorderedRect((240 / 2) + 9, (160 / 2) - 13, 7, 25, ((31) | (31)<<5 | (31)<<10), ((0) | (0)<<5 | (0)<<10));
}
...
void goToLose() {
    fillImage(42, 2, 156, 156, backgroundBitmap);
    fillScreen(((29) | (0)<<5 | (0)<<10));
    drawString((240 / 2) - 24, (160 / 2) - 4, "YOU DIED", ((31) | (31)<<5 | (31)<<10));
    char str[10];
    itoa(score, str, 10);
    if (score < 10) {
        drawString((240 / 2) - 3, (160 / 2) + 5, str, ((31) | (31)<<5 | (31)<<10));
    } else if (score < 100) {
        drawString((240 / 2) - 6, (160 / 2) + 5, str, ((31) | (31)<<5 | (31)<<10));
    } else {
        drawString((240 / 2) - 9, (160 / 2) + 5, str, ((31) | (31)<<5 | (31)<<10));
    }
    state = LOSE;
}
